...
export class PlaylistService {
  ...
  async createPlaylist(userId, name, description = '') {
    try {
      ...
      console.log('âœ… Playlist created:', docRef.id);
  ...
  async getUserPlaylists(userId) {
    try {
      ...
      console.error('âŒ Error loading playlists:', error);
      throw error;
    }
  }
  ...
  async getPlaylist(playlistId) {
    try {
      ...
      console.error('âŒ Error getting playlist:', error);
      throw error;
    }
  }
  ...
  async updatePlaylist(playlistId, updates) {
    try {
      ...
      console.error('âŒ Error updating playlist:', error);
      throw error;
    }
  }
  ...
  async addTrackToPlaylist(playlistId, trackData) {
    try {
      ...
      console.log('âœ… Track added to playlist:', track.title);
      return track;
    } catch (error) {
      console.error('âŒ Error adding track:', error);
      throw error;
    }
  }
  ...
  async removeTrackFromPlaylist(playlistId, trackId) {
    try {
      ...
      console.log('âœ… Track removed from playlist');
    } catch (error) {
      console.error('âŒ Error removing track:', error);
      throw error;
    }
  }
  ...
  async reorderTracks(playlistId, newTracksOrder) {
    try {
      ...
      console.log('âœ… Tracks reordered');
    } catch (error) {
      console.error('âŒ Error reordering tracks:', error);
      throw error;
    }
  }
  ...
  async searchPlaylists(userId, searchTerm) {
    try {
      ...
      console.error('âŒ Error searching playlists:', error);
      throw error;
    }
  }
}
