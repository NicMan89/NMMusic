export class YouTubePlayer {
  ...
  createPlayer() {
    try {
      ...
      console.error('âŒ Error creating player:', error);
    }
  }
  ...
  onPlayerError(event) {
    ...
    console.error('âŒ YouTube Player error:', error);
  ...
  loadVideo(videoId) {
    ...
    if (!videoId) {
      console.error('âŒ No video ID provided');
      return;
    }
    ...
    try {
      ...
      console.error('âŒ Error loading video:', error);
    }
  }
